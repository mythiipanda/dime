...
_PLANNER_PREFIX = (
    ...
    "to use get_draft_board / the 2025 draft class joined to "
    "CURRENT-season stats. Never answer rookie questions from "
    "silver_hist_player_seasons, and never use age as a rookie proxy "
