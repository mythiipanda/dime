...
async def test_recorded_root_evidence_persists_typed_source_identity(tmp_path):
    class C:
        ...
        async def execute(self,node,task,evidence):
            return EvidenceEnvelope(evidence_id='e',capability='team_ratings',source='fixture',observed_at=datetime.now(UTC),rows=[{'TEAM_NAME':'Oklahoma City Thunder'}],source_identity={'kind':'warehouse','warehouse_id':'frozen-eval','sha256':'6fd5dee1859327a5cb02e335b98e8a715fe47b9559db6fb6ed18c1f16c4fac3a'})
    ...
    assert payload['source_identity']=={'kind':'warehouse','warehouse_id':'frozen-eval','sha256':'6fd5dee1859327a5cb02e335b98e8a715fe47b9559db6fb6ed18c1f16c4fac3a'}
