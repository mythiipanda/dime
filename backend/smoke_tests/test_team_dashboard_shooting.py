"""
Smoke tests for the team_dashboard_shooting module.
Tests fetching team dashboard statistics by shooting splits.

This module tests the TeamDashboardByShootingSplits endpoint with various parameters
...
# --- Test Functions ---
def test_fetch_team_dashboard_shooting_basic():
    """Test fetching team dashboard shooting splits with default parameters."""
    print("\n=== Testing fetch_team_dashboard_shooting_splits_logic (basic) ===")
...
def test_fetch_team_dashboard_shooting_advanced():
    """Test fetching team dashboard shooting splits with advanced measure type."""
    print("\n=== Testing fetch_team_dashboard_shooting_splits_logic (Advanced) ===")
...
def test_fetch_team_dashboard_shooting_different_measure_types():
    """Test fetching team dashboard shooting splits with different measure types."""
    print("\n=== Testing fetch_team_dashboard_shooting_splits_logic with different measure types ===")
...
def test_fetch_team_dashboard_shooting_different_per_modes():
    """Test fetching team dashboard shooting splits with different per modes."""
    print("\n=== Testing fetch_team_dashboard_shooting_splits_logic with different per modes ===")
...
def test_fetch_team_dashboard_shooting_dataframe():
    """Test fetching team dashboard shooting splits with DataFrame output."""
    print("\n=== Testing fetch_team_dashboard_shooting_splits_logic with DataFrame output ===")

    # Test with return_dataframe=True
    result = fetch_team_dashboard_shooting_splits_logic(
        SAMPLE_TEAM_NAME,
        SAMPLE_SEASON,
        DEFAULT_SEASON_TYPE,
        DEFAULT_MEASURE_TYPE,
...
def test_fetch_team_dashboard_shooting_invalid_team():
    """Test fetching team dashboard shooting splits with an invalid team name."""
    print("\n=== Testing fetch_team_dashboard_shooting_splits_logic with invalid team ===")
...
def test_fetch_team_dashboard_shooting_with_team_id():
    """Test fetching team dashboard shooting splits with a team ID instead of name."""
    print("\n=== Testing fetch_team_dashboard_shooting_splits_logic with team ID ===")
...
def run_all_tests():
    ...
    print(f"=== Running team_dashboard_shooting smoke tests at {datetime.now().isoformat()} ===\n")
    ...
    try:
        # Run basic tests
        run_test(test_fetch_team_dashboard_shooting_basic, "Basic Dashboard")
        run_test(test_fetch_team_dashboard_shooting_advanced, "Advanced Measure Type")

        # Run comprehensive parameter tests
        run_test(test_fetch_team_dashboard_shooting_different_measure_types, "Different Measure Types")
        run_test(test_fetch_team_dashboard_shooting_different_per_modes, "Different Per Modes")

        # Run DataFrame and error tests
        run_test(test_fetch_team_dashboard_shooting_dataframe, "DataFrame Output")
        run_test(test_fetch_team_dashboard_shooting_invalid_team, "Invalid Team")
        run_test(test_fetch_team_dashboard_shooting_with_team_id, "Team ID")
