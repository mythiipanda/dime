"""
Smoke tests for the player_dashboard_game module.
Tests fetching player dashboard statistics by game splits.

This module tests the PlayerDashboardByGameSplits endpoint with various parameters
...
from backend.api_tools.player_dashboard_game import (
    fetch_player_dashboard_game_splits_logic,
...
# --- Test Functions ---
def test_fetch_player_dashboard_game_basic():
    """Test fetching player dashboard game splits with default parameters."""
    print("\n=== Testing fetch_player_dashboard_game_splits_logic (basic) ===")

    # Test with default parameters (JSON output)
    json_response = fetch_player_dashboard_game_splits_logic(
        SAMPLE_PLAYER_NAME,
        SAMPLE_SEASON,
        DEFAULT_SEASON_TYPE,
...
def test_fetch_player_dashboard_game_advanced():
    """Test fetching player dashboard game splits with advanced measure type."""
    print("\n=== Testing fetch_player_dashboard_game_splits_logic (Advanced) ===")
...
def test_fetch_player_dashboard_game_different_measure_types():
    """Test fetching player dashboard game splits with different measure types."""
    print("\n=== Testing fetch_player_dashboard_game_splits_logic with different measure types ===")
...
def test_fetch_player_dashboard_game_different_per_modes():
    """Test fetching player dashboard game splits with different per modes."""
    print("\n=== Testing fetch_player_dashboard_game_splits_logic with different per modes ===")
...
def test_fetch_player_dashboard_game_dataframe():
    """Test fetching player dashboard game splits with DataFrame output."""
    print("\n=== Testing fetch_player_dashboard_game_splits_logic with DataFrame output ===")

    # Test with return_dataframe=True
    result = fetch_player_dashboard_game_splits_logic(
        SAMPLE_PLAYER_NAME,
        SAMPLE_SEASON,
        DEFAULT_SEASON_TYPE,
        DEFAULT_MEASURE_TYPE,
...
def test_fetch_player_dashboard_game_invalid_player():
    """Test fetching player dashboard game splits with an invalid player name."""
    print("\n=== Testing fetch_player_dashboard_game_splits_logic with invalid player ===")
...
def run_all_tests():
    ...
    print(f"=== Running player_dashboard_game smoke tests at {datetime.now().isoformat()} ===\n")
    ...
    try:
        # Run basic tests
        run_test(test_fetch_player_dashboard_game_basic, "Basic Dashboard")
        run_test(test_fetch_player_dashboard_game_advanced, "Advanced Measure Type")

        # Run comprehensive parameter tests
        run_test(test_fetch_player_dashboard_game_different_measure_types, "Different Measure Types")
        run_test(test_fetch_player_dashboard_game_different_per_modes, "Different Per Modes")

        # Run DataFrame and error tests
        run_test(test_fetch_player_dashboard_game_dataframe, "DataFrame Output")
        run_test(test_fetch_player_dashboard_game_invalid_player, "Invalid Player")
