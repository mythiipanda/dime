"""
Smoke tests for the player_dashboard_lastn module.
Tests fetching player dashboard statistics by last N games.

This module tests the PlayerDashboardByLastNGames endpoint with various parameters
...
from backend.api_tools.player_dashboard_lastn import (
    fetch_player_dashboard_lastn_games_logic,
...
# --- Test Functions ---
def test_fetch_player_dashboard_lastn_basic():
    """Test fetching player dashboard last N games with default parameters."""
    print("\n=== Testing fetch_player_dashboard_lastn_games_logic (basic) ===")

    # Test with default parameters (JSON output)
    json_response = fetch_player_dashboard_lastn_games_logic(
        SAMPLE_PLAYER_NAME,
        SAMPLE_SEASON,
        DEFAULT_SEASON_TYPE,
...
def test_fetch_player_dashboard_lastn_advanced():
    """Test fetching player dashboard last N games with advanced measure type."""
    print("\n=== Testing fetch_player_dashboard_lastn_games_logic (Advanced) ===")
...
def test_fetch_player_dashboard_lastn_different_measure_types():
    """Test fetching player dashboard last N games with different measure types."""
    print("\n=== Testing fetch_player_dashboard_lastn_games_logic with different measure types ===")
...
def test_fetch_player_dashboard_lastn_different_per_modes():
    """Test fetching player dashboard last N games with different per modes."""
    print("\n=== Testing fetch_player_dashboard_lastn_games_logic with different per modes ===")
...
def test_fetch_player_dashboard_lastn_dataframe():
    """Test fetching player dashboard last N games with DataFrame output."""
    print("\n=== Testing fetch_player_dashboard_lastn_games_logic with DataFrame output ===")

    # Test with return_dataframe=True
    result = fetch_player_dashboard_lastn_games_logic(
        SAMPLE_PLAYER_NAME,
        SAMPLE_SEASON,
        DEFAULT_SEASON_TYPE,
        DEFAULT_MEASURE_TYPE,
...
def test_fetch_player_dashboard_lastn_invalid_player():
    """Test fetching player dashboard last N games with an invalid player name."""
    print("\n=== Testing fetch_player_dashboard_lastn_games_logic with invalid player ===")
...
def run_all_tests():
    ...
    print(f"=== Running player_dashboard_lastn smoke tests at {datetime.now().isoformat()} ===\n")
    ...
    try:
        # Run basic tests
        run_test(test_fetch_player_dashboard_lastn_basic, "Basic Dashboard")
        run_test(test_fetch_player_dashboard_lastn_advanced, "Advanced Measure Type")

        # Run comprehensive parameter tests
        run_test(test_fetch_player_dashboard_lastn_different_measure_types, "Different Measure Types")
        run_test(test_fetch_player_dashboard_lastn_different_per_modes, "Different Per Modes")

        # Run DataFrame and error tests
        run_test(test_fetch_player_dashboard_lastn_dataframe, "DataFrame Output")
        run_test(test_fetch_player_dashboard_lastn_invalid_player, "Invalid Player")
